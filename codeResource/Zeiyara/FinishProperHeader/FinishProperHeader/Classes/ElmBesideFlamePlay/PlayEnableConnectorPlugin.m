...
//: @implementation PlayEnableConnectorPlugin
@implementation PlayEnableConnectorPlugin
...
- (BOOL)shouldIgnoreNotification:(NIMNotificationObject *)notification
{
    ...
    {
        //: NSArray *types = [[PlanetMinimalLandscapePainter sharedConfig] ignoreTeamNotificationTypes];
        NSArray *types = [[PlanetMinimalLandscapePainter selectBy] recording];
...
- (BOOL)shouldIgnoreMessage:(NIMMessage *)message
{
    //: NIMMessageType type = [PlanetMinimalLandscapePainter sharedConfig].ignoreMessageType;
    NIMMessageType type = [PlanetMinimalLandscapePainter selectBy].packet;
