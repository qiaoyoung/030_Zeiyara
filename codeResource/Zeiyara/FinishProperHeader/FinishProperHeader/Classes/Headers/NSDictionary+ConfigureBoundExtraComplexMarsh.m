...
// __CLOSE_PRINT__
//
//  NSDictionary+ConfigureBoundExtraComplexMarsh.m
//  Kitalker
//
...
//: @implementation NSDictionary (ConfigureBoundExtraComplexMarsh)
@implementation NSDictionary (ConfigureBoundExtraComplexMarsh)

//: - (NSInteger)integerValueForKey:(id)key {
- (NSInteger)mountain:(id)key {
    //: return [[self objectForKey:key] integerValue];
    return [[self objectForKey:key] integerValue];
}

//: - (NSArray *)arrayValueForKey:(id)aKey{
- (NSArray *)walk:(id)aKey{
    //: if (!self || !aKey) {
    if (!self || !aKey) {
        //: return @[];
        return @[];
...
- (int)component:(id)key {
    //: return [[self objectForKey:key] intValue];
    return [[self objectForKey:key] intValue];
}

//: - (float)floatValueForKey:(id)key {
- (float)creation:(id)key {
