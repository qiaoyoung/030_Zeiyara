...
// __CLOSE_PRINT__
//
//  OriginalTupleWorkflowAnimator.h
 ...
 *  气泡设置
 */
//: @interface OriginalTupleWorkflowAnimator : NSObject
@interface OriginalTupleWorkflowAnimator : NSObject
...
@property (nonatomic, strong) UIColor *implement;

/**
 *  设置消息 Contentview 的文字字体
 */
//: @property (nonatomic, strong) UIFont *font;
@property (nonatomic, strong) UIFont *netFont;
...
@property (nonatomic, strong) UIFont *around;

/**
 *  设置消息普通模式下的背景图
 */
//: @property (nonatomic, strong) UIImage *normalBackgroundImage;
@property (nonatomic, strong) UIImage *willingSum;

//: @property (nonatomic, assign) UIEdgeInsets contentInsets;
@property (nonatomic, assign) UIEdgeInsets low;

/**
 *  设置消息按压模式下的背景图
 */
//: @property (nonatomic, strong) UIImage *highLightBackgroundImage;
@property (nonatomic, strong) UIImage *beImage;

/**
 *  设置消息 Contentview 的文字颜色
 */
//: @property (nonatomic, strong) UIColor *textColor;
@property (nonatomic, strong) UIColor *aRest;
