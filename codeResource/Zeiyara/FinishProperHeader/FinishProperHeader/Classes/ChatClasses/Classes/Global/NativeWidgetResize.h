...
#ifndef NativeWidgetResize_h
#define NativeWidgetResize_h


#if __has_include(<DistinctMutualWorkflowAnimatorProjector/DistinctMutualWorkflowAnimatorProjector.h>)
...
#elif __has_include("UIView+CoordinatorScanScroll.h")
