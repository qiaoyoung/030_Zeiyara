...
{
    TextureDecoderComposer *emoticonCatalog = [[FontTransformSync sharedManager] emoticonCatalog:NEEKIT_EmojiCatalog];
    if (emoticonCatalog) {
...
{
    TextureDecoderComposer *emoticonCatalog = [[FontTransformSync sharedManager] emoticonCatalog:NEEKIT_EmojiGifCatalog];
    if (emoticonCatalog) {
        FacadeTinyBalancer *layout = [[FacadeTinyBalancer alloc] initEmojiLayout:self.device_width];
        emoticonCatalog.layout = layout;
        emoticonCatalog.pagesCount = [self numberOfPagesWithEmoticon:emoticonCatalog];
