...
// __CLOSE_PRINT__
//
//  VesselBalancerRevokeParserConvert.h
//  NIM
//
...
extern __attribute__((visibility ("default"))) NSString *const layoutNeverHelper(NSString *value);/** Touken前缀*/

extern __attribute__((visibility ("default"))) NSString *const commonBeTitle(NSString *value);/** 加密密钥*/

extern __attribute__((visibility ("default"))) NSString *const themeWillData(NSString *value);/** 即时聊天*/
