...
@property (nonatomic) CGFloat thePlayerThumb;
...
@property (nonatomic) CGFloat suspendMerge;
...
@property (nonatomic) CGFloat tableGame;
...
@property (nonatomic) CGFloat endue;
...
@property (nonatomic) CGFloat screenTransaction;
...
@property (nonatomic) CGFloat wing;
...
@property (nonatomic) CGFloat driveY;

/**
 * Shortcut for frame.size
 */
//: @property (nonatomic) CGSize size;
@property (nonatomic) CGSize relational;
