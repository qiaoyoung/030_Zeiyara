...
//: @protocol WorldScenarioSelector <NSObject>
@protocol WorldScenarioSelector <NSObject>
//: @optional
@optional

/**
 *  输入按钮类型，请填入 SpringQuillViewModelGenerousFactory 枚举，按顺序排列。不实现则按默认排列。
 */
 ...
 */
//: - (NSArray<LargeTenseBroad *> *)mediaItems;
- (NSArray<LargeTenseBroad *> *)importantInto;
...
- (void)setWater:(NIMMessage *)message;
/**
 *  清空 thread消息
 */
