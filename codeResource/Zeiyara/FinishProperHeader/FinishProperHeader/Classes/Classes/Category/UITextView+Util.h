...
@property (nonatomic, copy) textViewHeightDidChangedBlock bounceNextChanged;
/* 占位文字颜色 */
//: @property (nonatomic, strong) UIColor *placeholderColor;
@property (nonatomic, strong) UIColor *unit;
/* 最大高度，如果需要随文字改变高度的时候使用 */
//: @property (nonatomic, assign) CGFloat maxHeight;
@property (nonatomic, assign) CGFloat label;
...
- (void)tallness:(CGFloat)maxHeight cornerPrime:(textViewHeightDidChangedBlock)textViewHeightDidChanged;
/* 获取图片数组 */
//: - (NSArray *)getImages;
- (NSArray *)cur;
/* 添加一张图片 image:要添加的图片 */
