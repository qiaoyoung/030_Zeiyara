...
#define kPeakDividerScaleManagerVersionKey @"kPeakDividerScaleManagerVersionKey"
...
- (NSString *)calculateAppResPath {
    ...
    NSString *resDir = [docuPath stringByAppendingPathComponent:kFinishProperHeader];
    ...
    NSString *fileResDir = [[docuPath stringByAppendingPathComponent:@"file"] stringByAppendingPathComponent:kFinishProperHeader];
    ...
    NSString *path = [[QuintessentialContentTreat sharedKit].emoticonBundle pathForResource:kFinishProperHeader ofType:@".zip"];
    if (!path) {
