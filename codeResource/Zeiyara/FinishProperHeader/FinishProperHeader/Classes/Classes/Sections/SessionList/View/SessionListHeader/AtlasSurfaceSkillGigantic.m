...
- (UIColor *)fillBackgroundColor:(AtlasSurfaceSkillGiganticType)type{
    NSDictionary *dict = @{
                           @(AtlasSurfaceSkillGiganticTypeNetStauts)    : UIColorFromRGB(0xFFE3E3),
                           @(AtlasSurfaceSkillGiganticTypeCommonText)   : UIColorFromRGB(0xff6347),
                           @(AtlasSurfaceSkillGiganticTypeLoginClients) : UIColorFromRGB(0xff6347)
                           };
    return dict[@(type)];
}
