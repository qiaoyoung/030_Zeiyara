...
//        NSString *title  = item[TabbarTitle];
    ...
    navBar.barTintColor = [UIColor colorWithPatternImage:[PlayfulExpandRepaintNeat getLinearGradientImage:RGB_COLOR_String(kCommonBGColor_begin) and:RGB_COLOR_String(kCommonBGColor_end) directionType:PlayfulExpandRepaintNeatDirectionVertical]];
    [navBar setTitleTextAttributes:dic];
    [navBar setShadowImage:[UIImage new]];
    [navBar setBackgroundImage:[PlayfulExpandRepaintNeat getLinearGradientImage:RGB_COLOR_String(kCommonBGColor_begin) and:RGB_COLOR_String(kCommonBGColor_end) directionType:PlayfulExpandRepaintNeatDirectionLevel] forBarMetrics:UIBarMetricsDefault];
    ...
    if (_configs == nil)
    {
        _configs = @{
                     ...
                     @(ChatBinderPresenterScopeTypeContact)     : @{
                             TabbarVC           : @"ThreadValueAroundExtract",
                     ...
                     @(ChatBinderPresenterScopeTypeSetting)     : @{
                             TabbarVC           : @"DeriveCollectorOnyxDatasetter",
