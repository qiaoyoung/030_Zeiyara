...
@property (assign, nonatomic) PromptHeathPlainStyle defaultStyle UI_APPEARANCE_SELECTOR;

/// Represents the type of mask applied when the HUD is displayed.
/// @discussion Default: PromptHeathPlainMaskTypeNone.
@property (assign, nonatomic) PromptHeathPlainMaskType defaultMaskType UI_APPEARANCE_SELECTOR;

/// Defines the animation type used when the HUD is displayed.
/// @discussion Default: PromptHeathPlainAnimationTypeFlat.
@property (assign, nonatomic) PromptHeathPlainAnimationType defaultAnimationType UI_APPEARANCE_SELECTOR;
