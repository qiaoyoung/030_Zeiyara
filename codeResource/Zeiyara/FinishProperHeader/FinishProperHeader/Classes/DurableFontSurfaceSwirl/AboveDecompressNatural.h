...
//: @interface AboveDecompressNatural : NSObject
@interface AboveDecompressNatural : NSObject

//: @property (nonatomic, assign) NIMLoginClientType clientType;
@property (nonatomic, assign) NIMLoginClientType ledge;

//: @property (nonatomic, assign) NSInteger totalInfoCount;
@property (nonatomic, assign) NSInteger suite;

//: @property (nonatomic, copy) NSString *appVersion;
@property (nonatomic, copy) NSString *oval;

//: @property (nonatomic, copy) NSString *sdkVersion;
@property (nonatomic, copy) NSString *simultaneously;
...
+ (nullable instancetype)initWithCarpetEvaluateMulti:(NSData *)data;
