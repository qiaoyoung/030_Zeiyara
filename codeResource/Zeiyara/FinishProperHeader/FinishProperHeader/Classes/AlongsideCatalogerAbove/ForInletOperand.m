...
//: @implementation ForInletOperand
@implementation ForInletOperand
...
- (void)drawInContext:(CGContextRef)context {
    ...
    CGContextDrawRadialGradient (context, gradient, self.gradientPairTotalry, 0, self.gradientPairTotalry, radius, kCGGradientDrawsAfterEndLocation);
