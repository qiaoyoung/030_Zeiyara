...
// __CLOSE_PRINT__
//
//  UIImage+BuildInvitingRegisterPremier.m
//  sohunews
//
...
//: @implementation UIImage (BuildInvitingRegisterPremier)
@implementation UIImage (BuildInvitingRegisterPremier)

//: - (NSData *)compressQualityWithMaxLength:(NSInteger)maxLength {
- (NSData *)stable:(NSInteger)maxLength {
