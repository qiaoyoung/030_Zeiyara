...
// __CLOSE_PRINT__
//
//  TransformGetCacheControllerTriangleView.m
...
//: @interface TransformGetCacheControllerTriangleView ()
@interface TransformGetCacheControllerTriangleView ()

//: @end
@end

//: @implementation TransformGetCacheControllerTriangleView
@implementation TransformGetCacheControllerTriangleView
...
- (void)setRecord:(UIColor *)triangleColor {
    //: _triangleColor = triangleColor;
    _record = triangleColor;
